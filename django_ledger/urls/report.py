...
urlpatterns = [
    ...
    # Entity .....
     path('entity/<slug:entity_slug>/cash-statement/',
         views.EntityModelCashStatementView.as_view(),
         name='entity-cf'),
    path('entity/<slug:entity_slug>/cash-statement/year/<int:year>/',
         views.FiscalYearEntityModelCashStatementView.as_view(),
         name='entity-cf-year'),
    path('entity/<slug:entity_slug>/cash-statement/quarter/<int:year>/<int:quarter>/',
         views.QuarterlyEntityModelCashStatementView.as_view(),
         name='entity-cf-quarter'),
    path('entity/<slug:entity_slug>/cash-statement/month/<int:year>/<int:month>/',
         views.MonthlyEntityModelCashStatementView.as_view(),
         name='entity-cf-month'),
    path('entity/<slug:entity_slug>/cash-statement/date/<int:year>/<int:month>/<int:day>/',
         views.MonthlyEntityModelCashStatementView.as_view(),
         name='entity-cf-date')
]
