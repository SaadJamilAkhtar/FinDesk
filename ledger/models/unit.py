...
from ledger.io.io_mixin import IOMixIn
from ledger.models.mixins import CreateUpdateMixIn, SlugNameMixIn, NodeTreeMixIn
...
class EntityUnitModelAbstract(IOMixIn, NodeTreeMixIn, SlugNameMixIn, CreateUpdateMixIn):
    ...
    entity = models.ForeignKey('ledger.EntityModel', on_delete=models.CASCADE, verbose_name=_('Unit Entity'))
