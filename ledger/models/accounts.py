...
from ledger.io.roles import ACCOUNT_ROLES, BS_ROLES, GROUP_INVOICE, GROUP_BILL
from ledger.models.mixins import CreateUpdateMixIn, NodeTreeMixIn
...
class AccountModelAbstract(NodeTreeMixIn, CreateUpdateMixIn):
    ...
    coa = models.ForeignKey('ledger.ChartOfAccountModel',
