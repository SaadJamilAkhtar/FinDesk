...
from ledger.models import LazyLoader
from ledger.models.entity import EntityModel
from ledger.models.mixins import CreateUpdateMixIn, LedgerPlugInMixIn, MarkdownNotesMixIn
...
class InvoiceModelAbstract(LedgerPlugInMixIn,
    ...
    invoice_items = models.ManyToManyField('ledger.ItemModel',
                                           through='ledger.ItemThroughModel',
    ...
    def get_mark_paid_url(self, entity_slug):
        return reverse('ledger:invoice-mark-paid',
                       kwargs={
