...
from ledger.forms.journal_entry import JournalEntryModelUpdateForm, JournalEntryModelCreateForm
from ledger.models.journalentry import JournalEntryModel
