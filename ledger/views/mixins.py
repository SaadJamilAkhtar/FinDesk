...
from ledger.models.entity import EntityReportManager
from ledger.utils import set_default_entity
...
class BaseDateNavigationUrlMixIn:
    ...
    def get_base_date_nav_url(self, context, **kwargs):
        ...
        context['date_navigation_url'] = reverse(f'ledger:{view_name_base}',
                                                 kwargs={
